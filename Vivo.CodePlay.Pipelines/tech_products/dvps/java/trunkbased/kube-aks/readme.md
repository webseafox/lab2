...
extends:  
  ...
  template: /tech_products/dvps/java/trunkbased/kube-aks/lite-ci.yaml@CodePlay
  # template: /tech_products/dvps/java/trunkbased/kube-aks/gold-ci.yaml@CodePlay
  # template: /tech_products/dvps/java/trunkbased/kube-aks/platinum-ci.yaml@CodePlay
  # template: /tech_products/dvps/java/trunkbased/kube-aks/diamond-ci.yaml@CodePlay
  parameters:
...
extends:  
  template: /tech_products/dvps/java/trunkbased/kube-aks/lite-cd.yaml@CodePlay
  # template: /tech_products/dvps/java/trunkbased/kube-aks/gold-cd.yaml@CodePlay
  # template: /tech_products/dvps/java/trunkbased/kube-aks/platinum-cd.yaml@CodePlay
  # template: /tech_products/dvps/java/trunkbased/kube-aks/diamond-cd.yaml@CodePlay
  parameters:
    # Gov app acronym para a service connection ex 'aks-{gov_app_acronym}-brsouth-dev', 
    gov_app_acronym: mvpk
...
extends:  
  template: /tech_products/dvps/java/trunkbased/kube-aks/lite-pr.yaml@CodePlay
  # template: /tech_products/dvps/java/trunkbased/kube-aks/gold-pr.yaml@CodePlay
  # template: /tech_products/dvps/java/trunkbased/kube-aks/platinum-pr.yaml@CodePlay
  # template: /tech_products/dvps/java/trunkbased/kube-aks/diamond-pr.yaml@CodePlay
```
