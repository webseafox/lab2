...
Implantacao de `Aplicativos Java` para `Kubernetes` (`AKS`) e `Helm Chart` atraves do `ACR`.
...
extends:  
  ...
  template: /tech_products/dvps/java/trunkbased/kube-aks-v2/lite-ci.yaml@CodePlay
  # template: /tech_products/dvps/java/trunkbased/kube-aks-v2/gold-ci.yaml@CodePlay
  # template: /tech_products/dvps/java/trunkbased/kube-aks-v2/platinum-ci.yaml@CodePlay
  # template: /tech_products/dvps/java/trunkbased/kube-aks-v2/diamond-ci.yaml@CodePlay
  parameters:
    # AKS Service connection ex 'aks-xyzk-brsouth-dev',
...
extends:  
  template: /tech_products/dvps/java/trunkbased/kube-aks-v2/lite-cd.yaml@CodePlay
  # template: /tech_products/dvps/java/trunkbased/kube-aks-v2/gold-cd.yaml@CodePlay
  # template: /tech_products/dvps/java/trunkbased/kube-aks-v2/platinum-cd.yaml@CodePlay
  # template: /tech_products/dvps/java/trunkbased/kube-aks-v2/diamond-cd.yaml@CodePlay
  parameters:
...
extends:  
  template: /tech_products/dvps/java/trunkbased/kube-aks-v2/lite-pr.yaml@CodePlay
  # template: /tech_products/dvps/java/trunkbased/kube-aks-v2/gold-pr.yaml@CodePlay
  # template: /tech_products/dvps/java/trunkbased/kube-aks-v2/platinum-pr.yaml@CodePlay
  # template: /tech_products/dvps/java/trunkbased/kube-aks-v2/diamond-pr.yaml@CodePlay
```
