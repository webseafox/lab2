# Implantacao em Kubernetes com pipeline Lite para ACR com kube-config file
...
extends:  
  template: /tech_products/dvps/java/kube-acr/lite-ci.yaml@CodePlay
  parameters:
...
extends:  
  template: /tech_products/dvps/java/kube-acr/lite-cd.yaml@CodePlay
  parameters:
   # valores aceitaveis sao [dev | test | prod | esteira1 | esteira2 | preprod | prodlike]
