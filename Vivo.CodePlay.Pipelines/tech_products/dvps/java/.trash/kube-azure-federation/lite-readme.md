...
extends:  
  template: /tech_products/dvps/java/kube-azure-federation/lite-ci.yaml@CodePlay
  parameters:
...
extends:  
  template: /tech_products/dvps/java/kube-azure-federation/lite-cd.yaml@CodePlay
  parameters:
   # valores aceitaveis sao [dev | test | prod | esteira1 | esteira2 | preprod | prodlike]
