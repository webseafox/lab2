...
Implantacao de `Aplicativos NodeJs` para `Kubernetes` (`AKS`) e `Helm Chart` atraves do `ACR`, usando **Federeted Identity**.

### Capacidades
* Lite
  * **Constroi**, **Testa** e **Empacota** projeto `NodeJs` x `Npm`
...
- https://dev.azure.com/telefonica-vivo-brasil/DevOps/_git/Vivo.Helm.Generic.Microservice?path=/values.yaml&_a=contents&version=GBmaster
...
extends:  
  template: /tech_products/dvps/nodejs/trunkbased/kube-aks/lite-ci.yaml@CodePlay
  # template: /tech_products/dvps/nodejs/trunkbased/kube-aks/gold-ci.yaml@CodePlay
  # template: /tech_products/dvps/nodejs/trunkbased/kube-aks/platinum-ci.yaml@CodePlay
  # template: /tech_products/dvps/nodejs/trunkbased/kube-aks/diamond-ci.yaml@CodePlay
  parameters:
...
extends:  
  template: /tech_products/dvps/nodejs/trunkbased/kube-aks/lite-cd.yaml@CodePlay
  # template: /tech_products/dvps/nodejs/trunkbased/kube-aks/gold-cd.yaml@CodePlay
  # template: /tech_products/dvps/nodejs/trunkbased/kube-aks/platinum-cd.yaml@CodePlay
  # template: /tech_products/dvps/nodejs/trunkbased/kube-aks/diamond-cd.yaml@CodePlay
  parameters:
    # Gov app acronym para a service connection ex 'aks-xyzk-brsouth-dev',
    kubernetes_connection: aks-kcli-brsouth-${{ parameters.environment }}
    resource_group: rg-aks-kcli-brsouth-${{ parameters.environment }}
...
* **aks-**[`gov_app_acronym`]**-brsouth-dev**
* **aks-**[`gov_app_acronym`]**-brsouth-esteira[1...N]** (*opcional*)
* **aks-**[`gov_app_acronym`]**-brsouth-preprod** (*opcional*)
* **aks-**[`gov_app_acronym`]**-brsouth-production**
* **aks-**[`gov_app_acronym`]**-brsouth-prodlike** (*opcional*)
