...
git clone https://$(GITUSER):$(GITPASS)@dev.azure.com/telefonica-vivo-brasil/VVCP%%20-%%20VIVOCORP/_git/src.src-vivocorp-dev1 C:\Siebel_Devops\ambientes\dev1\src-vivocorp-dev1
