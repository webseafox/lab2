...
set BRANCH = "origin"
cd C:\Siebel_Devops\QA1

git clone https://$(GITUSER):$(GITPASS)@dev.azure.com/telefonica-vivo-brasil/VVCP%%20-%%20VIVOCORP/_git/src.src-vivocorp-qa1 C:\Siebel_Devops\QA1\ambientes\src-vivocorp-qa1

cd C:\Siebel_Devops\QA1\ambientes\src-vivocorp-qa1

git describe --abbrev=0 --tags > C:\Siebel_Devops\QA1\ambientes\VERSION.log
rem git tag --sort=committerdate | tail -1 > C:\Siebel_Devops\QA1\ambientes\VERSION.log

cd C:\Siebel_Devops\QA1\ambientes\
...
git diff %VERSION_old% %timestamp% --name-only > C:\Siebel_Devops\QA1\ambientes\new_sifs.log
...
echo %%a
echo F|xcopy C:\Siebel_Devops\QA1\ambientes\src-vivocorp-qa1\"%%a" C:\Siebel_Devops\QA1\temp\"%%a"
)

cd C:\Siebel_Devops\QA1\ambientes\src-vivocorp-qa1
rem git push --delete origin %VERSION_old%-temp
cd C:\Siebel_Devops\QA1\ambientes\
RD /S /Q "C:\Siebel_Devops\QA1\ambientes\src-vivocorp-qa1"
