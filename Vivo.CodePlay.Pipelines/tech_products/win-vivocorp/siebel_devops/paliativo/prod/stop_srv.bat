...
rem Server 24 a 27
ssh pcpweb@10.238.6.65 "nohup sudo -u supweb /opt/web/siebel/siebel811/siebsrvr/scripts/stop_srv.sh > /tmp/devops/stop_devops.log &"
ssh pcpweb@10.238.6.66 "nohup sudo -u supweb /opt/web/siebel/siebel811/siebsrvr/scripts/stop_srv.sh > /tmp/devops/stop_devops.log &"
