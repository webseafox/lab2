...
echo ==================================================
echo === INICIO DO SCRIPT start_srv_new_az.bat
echo ===
echo ==================================================
...
:: Inicialização
:: ---------------------------
echo Script: Iniciar servidores Siebel 1 e 2 com delay
echo Propósito: %date% %time%
echo Data/Hora:

echo Iniciando processo de start dos servidores Siebel...
echo Este processo inclui delays de 260 segundos entre os servidores 1 e 2
echo.
...
if "!exitCode!"=="0" (
    echo Comando de start enviado com sucesso para 10.238.7.12 ^(siebelsrv1^)
...
set "exitCode=!ERRORLEVEL!"
if "!exitCode!"=="0" (
    echo Comando de start enviado com sucesso para 10.238.7.13 ^(siebelsrv2^)
    set /A successCount+=1
) else (
