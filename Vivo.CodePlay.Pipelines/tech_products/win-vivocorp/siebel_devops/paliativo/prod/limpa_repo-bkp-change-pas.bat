...
xcopy C:\Siebel_Devops\PROD\limpa\src.src-vivocorp-prod\.azuredevops C:\Siebel_Devops\PROD\limpa\stage\ /E /Y
...
echo F|xcopy C:\Siebel_Devops\PROD\limpa\stage\.azuredevops C:\Siebel_Devops\PROD\limpa\src.src-vivocorp-prod\ /E /Y
