...
rem sftp -b C:\Siebel_Devops\scripts\sftp_put_prod_new.txt pcpweb@10.238.6.65 22
rem sftp -b C:\Siebel_Devops\scripts\sftp_put_prod_new.txt pcpweb@10.238.6.66 22
