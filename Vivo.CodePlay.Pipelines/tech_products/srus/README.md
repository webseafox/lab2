...
São, atualmente, mantidos pela equipe de DevOps e estão estruturados em 3 grupos
...
Em fase de planejamento: Testes automatizados para garantir a qualidade dos templates e alterações para prevenir impactos nos clientes do Core Pipeline.
