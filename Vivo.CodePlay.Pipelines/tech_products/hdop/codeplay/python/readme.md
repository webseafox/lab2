...
## Capacidades
* Lite
  * **Constroi**, **Testa** e **Empacota** projeto `Python` x `Artifacts`
  * Atende modelos de projetos **python** com manifesto **pyproject.toml**.
...
extends:  
  template: /tech_products/hdop/codeplay/python/lite-ci.yaml@CodePlay
  # template: /tech_products/hdop/codeplay/python/gold-ci.yaml@CodePlay
  # template: /tech_products/hdop/codeplay/python/platinum-ci.yaml@CodePlay
  # template: /tech_products/hdop/codeplay/python/diamond-ci.yaml@CodePlay
  parameters:
    variable_groups:
...
extends:  
  template: /tech_products/hdop/codeplay/python/lite-cd.yaml@CodePlay
  # template: /tech_products/hdop/codeplay/python/gold-cd.yaml@CodePlay
  # template: /tech_products/hdop/codeplay/python/platinum-cd.yaml@CodePlay
  # template: /tech_products/hdop/codeplay/python/diamond-cd.yaml@CodePlay
  parameters:
    variable_groups:
    - ms-teste-pipeline-e2e-remover-v1
    - azdo-team-project-variables
...
extends:  
  template: /tech_products/hdop/codeplay/python/lite-pr.yaml@CodePlay
  # template: /tech_products/hdop/codeplay/python/gold-pr.yaml@CodePlay
  # template: /tech_products/hdop/codeplay/python/platinum-pr.yaml@CodePlay
  # template: /tech_products/hdop/codeplay/python/diamond-pr.yaml@CodePlay
  parameters:
   # valores aceitaveis sao [dev | test | production | esteira1 | esteira2 | preprod | prodlike]
    variable_groups:
    - ms-teste-pipeline-e2e-remover-v1
